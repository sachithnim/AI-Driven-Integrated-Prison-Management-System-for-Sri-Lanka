      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <p className="text-slate-600">
            AI-powered multimodal surveillance for unauthorized activities
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
                ...
                {isStreamActive ? (
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-4 right-4 bg-red-600/90 text-white px-3 py-1.5 rounded-full text-xs font-bold animate-pulse flex items-center gap-2 shadow-lg backdrop-blur-sm border border-red-500">
                      <div className="w-2 h-2 bg-white rounded-full"></div> AI
                      PROCESSING ACTIVE
                    </div>
                    <button
                  ...
                  <div className="text-center p-8">
                    ...
                    <p className="text-slate-400 mb-6 max-w-sm mx-auto">
                      Activate the AI violation detection models to monitor the
                      camera feed for weapons, fights, and audio disturbances.
                    </p>
                    <button
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          <Video size={20} /> <Mic size={20} /> Start Live Feed
                        </>
                      )}
                    </button>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <StatCard
                label="Model Status"
                value={isStreamActive ? "Running" : "Idle"}
                icon="⚡"
                color={isStreamActive ? "text-green-600" : "text-slate-500"}
              />
            </div>
          </div>
